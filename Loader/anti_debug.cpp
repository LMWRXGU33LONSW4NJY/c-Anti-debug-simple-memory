...
const wchar_t* security::internal::get_string(int index) {
	...
	case 0: value =  ("OLLYDBG"); break;
	case 1: value =  ("SunAwtFrame"); break;
	case 2: value = ("ID"); break;
	case 3: value =  ("antidbg"); break;
	case 4: value = ("x64dbg"); break;
	case 5: value =  ("%random_environment_var_name_that_doesnt_exist?[]<>@\\;*!-{}#:/~%"); break;
	case 6: value =  ("%random_file_name_that_doesnt_exist?[]<>@\\;*!-{}#:/~%"); break;
	}
...
int security::internal::virtualization::vm() {
	...
	h_key = 0;
	char* s_subkey = (char*)("SYSTEM\\CurrentControlSet\\Enum\\IDE");
	wchar_t w_subkey[22];
...
security::internal::debug_results security::check_security() {
	...
	//check the windows is remote debugger present variable
	...
	//check if debuggerpresent is true
